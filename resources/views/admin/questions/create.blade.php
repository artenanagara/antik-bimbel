...
@section('page-subtitle', 'Susun soal, pilihan jawaban, dan pembahasan')
@section('back')
        ...
        <div class="space-y-5">
            <section class="rounded-2xl border border-slate-200 bg-white">
                <div class="border-b border-slate-100 px-5 py-4">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Tulis pertanyaan utama dan pembahasan yang akan dibaca siswa.
                    </p>
                </div>
                <div class="space-y-4 p-5">
                    ...
                    <div>
                        @include('admin.questions.partials.rich-editor', [
                            ...
                            'value' => '',
                            'rows' => 4,
                            'placeholder' => 'Tambahkan pembahasan agar siswa paham alasan jawabannya...',
                        ])
                    </div>
                </div>
            </section>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white">
                <div
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">TWK/TIU memakai satu jawaban benar. TKP memakai skor 1-5.
                        </p>
                    </div>
                ...
                <div class="space-y-4 p-5">
                    <div>
                        ...
                        <x-form.select name="sub_test" id="sub_test" required placeholder="Pilih sub test" icon="tag"
                            :options="['TWK' => 'TWK', 'TIU' => 'TIU', 'TKP' => 'TKP']" :selected="old('sub_test')" />
                        @error('sub_test')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
